...
/**
 * VintoView gestisce l'interfaccia utente per la schermata che appare quando il giocatore vince nel gioco Bomberman.
 ...
 * @see JLabel
 */
public class VintoView extends JPanel {
	/**
    ...
    /**
     * Pannello principale per la schermata di vittoria.
     */
    ...
    /**
     * Costruisce la vista della schermata di vvittoria con il frame di riferimento.
     * 
     * @param frame Il frame principale del gioco.
     */
    public VintoView(JFrame frame) {
        ...
        try {
            BufferedImage backgroundImage = ImageIO.read(getClass().getResourceAsStream("/backVictory.png"));
    ...
    private void updateLayout() {
        ...
        scaler.scaleLabelImage(backgroundLabel, "/backVictory.png", overlaySize);
    ...
    /**
     * Alterna la visibilità della schermata di vittoria.
     * 
